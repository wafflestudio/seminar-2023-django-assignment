# Generated by Django 3.2 on 2023-11-22 17:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.ManyToManyField(blank=True, related_name='tag', to='blogs.Comment')),
                ('post', models.ManyToManyField(blank=True, related_name='tag', to='blogs.Post')),
            ],
        ),
        migrations.AddField(
            model_name='comment',
