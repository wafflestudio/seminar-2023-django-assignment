...
def create_question(question_text, days):
    ...
    offset to now (negative for questions published in the past, positive for qeustions that have yet
    to be published)
    """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        question.choice_set.create(choice_text="test")
        response = self.client.get(reverse("polls:index"))
    ...
    def test_future_question_and_past_question(self):
        ...
        question1.choice_set.create(choice_text="test")
        question2 = create_question("Future question", 30)
        question2.choice_set.create(choice_text="test")
        response = self.client.get(reverse("polls:index"))
        self.assertQuerySetEqual(
            response.context["latest_question_list"],
            [question1]
    ...
    def test_question_with_no_choice(self):
        create_question("Question with no choice.", days=-5)
        response = self.client.get(reverse("polls:index"))
        self.assertQuerySetEqual(
            response.context["latest_question_list"],
            []
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        ...
        future_question.choice_set.create(choice_text="test")
    ...
    def test_past_question(self):
        ...
        past_question.choice_set.create(choice_text="test")
